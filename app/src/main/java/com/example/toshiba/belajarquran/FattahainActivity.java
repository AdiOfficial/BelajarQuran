...
public class FattahainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray abjads = getResources().obtainTypedArray(R.array.fattahain);
        final TypedArray sounds = getResources().obtainTypedArray(R.array.sound_fattahain);
        RecyclerView.Adapter adapter = new AbjadAdapter(this, abjads, new AbjadAdapter.OnMusicStartListener() {
            ...
            public void startMusic(int position) {
                ...
                mp = MediaPlayer.create(FattahainActivity.this,sounds.getResourceId(position,R.raw.button));
                mp.start();
            }
        });
