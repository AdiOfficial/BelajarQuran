...
public class FattahActivity extends AppCompatActivity {
    MediaPlayer mp = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray abjads = getResources().obtainTypedArray(R.array.fattah);
        final TypedArray sounds = getResources().obtainTypedArray(R.array.sound_fattah);
        RecyclerView.Adapter adapter = new AbjadAdapter(this, abjads, new AbjadAdapter.OnMusicStartListener() {
            ...
            public void startMusic(int position) {
                ...
                mp = MediaPlayer.create(FattahActivity.this,sounds.getResourceId(position,R.raw.button));
                mp.start();
            }
        });
