...
public class KasrahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray abjads = getResources().obtainTypedArray(R.array.kasrah);
        final TypedArray sounds = getResources().obtainTypedArray(R.array.sound_kasrah);
        RecyclerView.Adapter adapter = new AbjadAdapter(this, abjads, new AbjadAdapter.OnMusicStartListener() {
            ...
            public void startMusic(int position) {
                ...
                mp = MediaPlayer.create(KasrahActivity.this,sounds.getResourceId(position,R.raw.button));
                mp.start();
            }
        });
