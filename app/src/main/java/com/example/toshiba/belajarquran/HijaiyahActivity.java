...
public class HijaiyahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray abjads = getResources().obtainTypedArray(R.array.hijaiyah);
        final TypedArray sounds = getResources().obtainTypedArray(R.array.sound_hijaiyah);
        RecyclerView.Adapter adapter = new AbjadAdapter(this, abjads, new AbjadAdapter.OnMusicStartListener() {
            ...
            public void startMusic(int position) {
                ...
                mp = MediaPlayer.create(HijaiyahActivity.this,sounds.getResourceId(position,R.raw.button));
                mp.start();
            }
        });
