...
public class DammahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TypedArray abjads = getResources().obtainTypedArray(R.array.dammah);
        final TypedArray sounds = getResources().obtainTypedArray(R.array.sound_dammah);
        RecyclerView.Adapter adapter = new AbjadAdapter(this, abjads, new AbjadAdapter.OnMusicStartListener() {
            ...
            public void startMusic(int position) {
                ...
                mp = MediaPlayer.create(DammahActivity.this,sounds.getResourceId(position,R.raw.button));
                mp.start();
            }
        });
